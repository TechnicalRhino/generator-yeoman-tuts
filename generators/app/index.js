...
module.exports = class extends Generator {
  prompting() {
    this.log(yosay(
      `Welcome ${chalk.red.underline(process.env.USER)} to the astonishing ${chalk.red('generator-yeoman-tuts')} generator!`
    ));
  ...
  writing() {
    //First we need to create the package.json content.
